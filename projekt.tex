...
%\documentclass[cprint]{fitthesis} % JEN ISP pro barevný tisk - odkazy jsou černé, znak VUT barevný
...
\projectinfo{
  ...
  title.cs={Implementace jednoduchého rozpoznávače řeči pro Android},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Implementation of Simple Speech Recognizer in Android}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Petr Flajšingr},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Petr},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Flajšingr},   %prijmeni autora (pro citaci) / author surname (for reference) 
  ...
  supervisor.surname={Szőke},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
...
\abstract[en]{The subject of this thesis is an implementation and optimization of speech recognizer for operating system Android. This work covers implementation of recording of an audio signal and the subsequent feature extraction using Mel filter banks and neural network. It also contains information about implementation of dynamic decoder. The work focuses on implementation in low-level tools such as Android NDK and Renderscript and evaluates the success rate of the recognizer and its memory and time requirements.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{rozpoznávání řeči, Android, NDK, Renderscript, neuronové sítě, dekodér, extrakce příznaků}
\keywords[en]{speech recognition, Android, NDK, Renderscript, neural networks, decoder, feature extraction}
...
\acknowledgment{Chtěl bych poděkovat vedoucímu práce Ing. Igoru Szőke, Ph.D. za odborné konzultace a pomoc při řešení
této práce. Dále také děkuji Danielu Jarošovi za korekturu tohoto textu.}
